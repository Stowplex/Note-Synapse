...
// in note_synapse/test/adaptive_skill_pinning_test.dart.
...
import 'package:note_synapse/models/model_config.dart' as _i24;
import 'package:note_synapse/models/model_type.dart' as _i25;
...
import 'package:note_synapse/services/model_selector.dart' as _i23;
...
class MockDatabaseService extends _i1.Mock implements _i3.DatabaseService {
  ...
  @override
  _i4.Future<bool> computeConversationMessageVisibility(
    String? messageId, {
    _i2.DatabaseExecutor? executor,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<List<_i3.ChunkFtsMatch>> searchChunksLexical(
    String? ftsQuery, {
    int? limit = 5000,
    ...
    String? noteId,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i4.Future<List<_i3.ChunkFtsMatch>>.value(
              <_i3.ChunkFtsMatch>[],
            ),
          )
          as _i4.Future<List<_i3.ChunkFtsMatch>>);

  @override
  _i4.Future<List<_i3.SearchChunkRow>> getSearchChunksByIds(
    List<int>? chunkIds, {
    Set<String>? sourceTypes,
    String? noteId,
  }) =>
      (super.noSuchMethod(
            ...
            returnValue: _i4.Future<List<_i3.SearchChunkRow>>.value(
              <_i3.SearchChunkRow>[],
            ),
          )
          as _i4.Future<List<_i3.SearchChunkRow>>);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockModelSelector extends _i1.Mock implements _i23.ModelSelector {
  MockModelSelector() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i4.Future<void> switchToModel(_i24.ModelConfig? config) =>
      (super.noSuchMethod(
  ...
  @override
  List<_i25.ModelType> getAvailableModels() =>
      (super.noSuchMethod(
            Invocation.method(#getAvailableModels, []),
            returnValue: <_i25.ModelType>[],
          )
          as List<_i25.ModelType>);
  ...
  _i4.Future<String> generateWithMessages(
    List<_i19.PromptMessage>? messages, {
    double? temperature,
    int? topK,
    double? topP,
    int? maxOutputTokens,
  ...
  @override
  _i4.Future<String> generateFromPromptExact(
    _i19.PromptRequest? request, {
    required _i24.ModelConfig? config,
    double? temperature,
    int? topK,
    double? topP,
    int? maxOutputTokens,
  ...
  List<Map<String, dynamic>> buildToolDeclarations(
    Map<String, List<_i26.McpTool>>? toolsByEndpoint, {
    _i20.GenerationContext? generationContext,
  }) =>
      (super.noSuchMethod(
            Invocation.method(
  ...
  @override
  _i4.Future<_i24.ModelConfig?> getModelByHint(
    List<String>? hints, {
    _i24.ModelConfig? currentOverride,
  }) =>
      (super.noSuchMethod(
            Invocation.method(
              #getModelByHint,
            ...
            returnValue: _i4.Future<_i24.ModelConfig?>.value(),
          )
          as _i4.Future<_i24.ModelConfig?>);

  @override
  _i4.Future<_i24.ModelConfig?> selectModelByPreference(
