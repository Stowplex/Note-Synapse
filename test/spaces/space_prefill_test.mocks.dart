...
// in note_synapse/test/spaces/space_prefill_test.dart.
...
import 'package:note_synapse/services/content_ingestion_service.dart' as _i24;
...
/// A class which mocks [ContentIngestionService].
///
/// See the documentation for Mockito's code generation for more information.
class MockContentIngestionService extends _i1.Mock
    implements _i24.ContentIngestionService {
  MockContentIngestionService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<void> processNote(
    _i8.Note? note,
    _i25.AppProvider? appProvider, {
    dynamic Function(String)? onMessage,
    ...
    dynamic Function()? onSuccess,
      ...
      (super.noSuchMethod(
            Invocation.method(
              #processNote,
              [note, appProvider],
              {#onMessage: onMessage, #onError: onError, #onSuccess: onSuccess},
            ),
            returnValue: _i7.Future<void>.value(),
            returnValueForMissingStub: _i7.Future<void>.value(),
          )
