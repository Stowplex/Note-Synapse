...
void main() {
  ...
  group('stampData', () {
    ...
    test('replaces a non-list tags value instead of throwing', () {
      scope.setActive('s1', ['thesis']);
      expect(scope.stampData(<String, dynamic>{'tags': 'garbage'})['tags'], [
        'thesis',
      ]);
  ...
  group('noteInScope', () {
    ...
    test('the all-spaces tag is always in scope', () {
      scope.setActive('s1', ['thesis', '2026']);
      expect(scope.noteInScope(const [SpaceScopeService.allSpacesTag]), isTrue);
      expect(
  ...
  group('isReservedTag', () {
    test('covers the two tags the app assigns meaning to', () {
      expect(
        SpaceScopeService.isReservedTag(SpaceScopeService.allSpacesTag),
        isTrue,
      );
      expect(
        SpaceScopeService.isReservedTag(SkillService.agentSkillTag),
        isTrue,
      );
    });
