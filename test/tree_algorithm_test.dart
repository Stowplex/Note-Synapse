...
void main() {
  group('Tree Building Algorithm Logic Tests', () {
    ...
    test('Forked conversation node creation logic', () {
      ...
      // Find fork message index
      final forkMessageId = forkedConversation.forkFromMessageId!;
      final forkMessageIndex = forkedMessages.indexWhere((msg) => msg.id == forkMessageId);
      
      expect(forkMessageIndex, equals(1)); // Should be at index 1 (the AI response)

      // Get new messages after fork point
