...
class SyncSession {
  /// [changeNotifier] is where Phase B and Phase C announce what they landed
  /// (`sync_change_publisher.dart`); it defaults to the process-wide
  /// `DataChangeNotifier.shared()`, and is injectable so a test can drive two
  /// simulated devices in one process without them sharing one notifier.
  SyncSession(
