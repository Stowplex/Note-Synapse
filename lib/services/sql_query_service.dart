...
class SqlQueryService {
  ...
  ///
  /// Delegates to [DataChangeEvent.maxTargetedNoteIds] rather than declaring
  /// its own number: the sync engine's `SyncChangePublisher` makes the same
  /// call for the same consumers, and two independently-maintained ceilings
  /// for one decision is how they drift.
  static const int maxTargetedRefreshIds = DataChangeEvent.maxTargetedNoteIds;
