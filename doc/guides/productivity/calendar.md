...
### Task States
Tap the status dropdown menu on any task card to change its state:
...
*   **Multi-Select**: Use the filter icon to select multiple combination of tags or tag filters.

### Heatmap Logic
The colored bar under each date show the density of tasks:
*   **Red**: Pending / To Do
*   **Amber**: In Progress
*   **Green**: Completed
*   **Grey**: Cancelled
